 ...
 *  Source Code: http://cdn.binaryjs.com/0/binary.js
 *
 *  Notes:  the definitions in this file are used within `getUserMedia.js`
 */
...
BinaryStream.prototype._write = function(code, data, bonus) {
  ...
  var message = util.pack([code, data, bonus]);
y  return this._socket.send(message) !== false;
};
